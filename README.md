...
| allowLocal.enabled                                                         | Enable local file system (confirm your instance has /illumidesk-nb-exchange-directory
and /illumidesk-courses directory)                 | FALSE                                                                               |
...
| illumideskSettings.customAuthType                                          | Provide Authorization Type for Illumidesk Stack: "DUMMY", "AUTH0", "LTI11","LTI13"                                                       | DUMMY                                                                               |
| illumideskSettings.lti13AuthorizeUrl                                       | Authorization URL for your LMS environment                                                                                               | https://illumidesk.instructure.com/api/lti/authorize_redirect                       |
| illumideskSettings.lti13ClientId                                           | ClientID that is tied to your Illumidesk Stack                                                                                           | NONE                                                                                |
| illumideskSettings.lti13Endpoint                                           | LTI 1.3 Endpoint for your LMS environment                                                                                                | https://illumidesk.instructure.com/api/lti/security/jwks                            |
| illumideskSettings.lti13TokenUrl                                           | Token URL for your LMS environment                                                                                                       | https://illumidesk.instructure.com/login/oauth2/token                               |
| illumideskSettings.ltiConsumerKey                                          | LTI 1.1 Consumer Key                                                                                                                     | lti_consumer_key                                                                    |
| illumideskSettings.oidcAuthorizeUrl                                        | OIDC Authorize URL for Single Sign On                                                                                                    | https://auth.illumidesk.com/authorize                                               |
| illumideskSettings.oidcCallbackUrl                                         | OIDC Callback URL for Single Sign On                                                                                                     | http://localhost:8000/hub/oauth_callback                                            |
| illumideskSettings.oidcClientId                                            | OIDC Client ID for single SIgn On                                                                                                        | 127000000008                                                                        |
| illumideskSettings.oidcTokenUrl                                            | OIDC Token URL for Single Sign On                                                                                                        | https://auth.illumidesk.com/authorize                                               |
| illumideskSettings.oidcUserData                                            | OIDC User Data endpoint for Single Sign On                                                                                               | https://auth.illumidesk.com/userinfo                                                |
| illumideskSettings.postgresDB                                              | Postgres Database used by the Illumidesk Stack                                                                                           | illumidesk                                                                          |
| illumideskSettings.postgresHost                                            | Postgres Host Name used by Illumidesk Stack                                                                                              | {{ .Release.Namespace }}-postgresql.{{ .Release.Namespace }}.svc.cluster.local      |
| illumideskSettings.postgresPort                                            | Postgres Port used by Illumidesk Stack                                                                                                   | 5432                                                                                |
| illumideskSettings.postgresUser                                            | Postgres User used by Illumides Stack                                                                                                   | postgres                                                                            |
